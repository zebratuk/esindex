...
/**
 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.18/analysis-dict-decomp-tokenfilter.html
 */
class DictionaryDecompounder extends AbstractFilter
{
    /**
     * @var string[]
     */
    ...
    {
        return FilterTypeEnum::DICTIONARY_DECOMPOUNDER;
    }
