...
/**
 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.18/analysis-word-delimiter-graph-tokenfilter.html
 */
class WordDelimiterGraph extends AbstractFilter
{
    use HasPreserveOriginal;

    private ?bool $adjustOffsets = null;
    ...
    private ?bool $ignoreKeywords = null;
    /**
     * @var string[]
     */
    ...
    {
        return FilterTypeEnum::WORD_DELIMITER_GRAPH;
    }

    #[BooleanFieldOption('adjust_offsets')]
    public function getAdjustOffsets(): ?bool
    {
        return $this->adjustOffsets;
    }

    public function setAdjustOffsets(?bool $value): self
    {
    ...
    #[BooleanFieldOption('ignore_keywords')]
    public function getIgnoreKeywords(): ?bool
    {
        return $this->ignoreKeywords;
    }

    public function setIgnoreKeywords(?bool $value): self
    {
