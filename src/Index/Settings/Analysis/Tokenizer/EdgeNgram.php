...
/**
 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.18/analysis-edgengram-tokenizer.html
 */
class EdgeNgram extends AbstractTokenizer
{
    use HasTokenChars;
    ...
    {
        return TokenizerTypeEnum::EDGE_NGRAM;
    }
}
